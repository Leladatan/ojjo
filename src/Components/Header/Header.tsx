        ...
        <header className="header">
            <div className="container">
                <div className="header__content">
                    <Logo handlerMenuTarget={handlerMenuTarget}/>
                    <Register/>
                    <HeaderMenu isOpen={isOpen} setIsOpen={setIsOpen}/>
                    {
                        isOpen
                            ?
                            <div className="header__menu__burger__content">
                                <div className="header__menu__burger__content__register" onClick={handlerMenuTarget}>
                                    <span>
                                        Вход/Регистрация
                                    </span>
                                </div>
                                <div className="header__menu__burger__content__contacts">
                                    <Link to="/contacts" className="header__menu__burger__content__contacts_link"
                                          onClick={handlerMenuTarget}>
                                        Контакты
                                    </Link>
                                </div>
                                <div className="header__menu__burger__content__list__society">
                                    <a href="/" onClick={handlerMenuTarget}>
